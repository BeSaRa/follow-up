...
import { CrudService, CrudServiceContract } from './crud-service'
...
export interface CrudWithDialogServiceContract<
  Model,
  Component,
  PrimaryKeyType = number,
> extends CrudServiceContract<Model, PrimaryKeyType> {
  ...
  implements CrudWithDialogServiceContract<Model, Component, PrimaryKeyType>
{
  ...
  openCreateDialog(model?: Model): MatDialogRef<Component> {
    return this.dialogService.open<Component, CrudDialogData<Model>>(
